							...
							<tbody>
								<c:forEach items="${projList}" var="projList" varStatus="count">
									<tr class="table-flag-blue">
										...
										<td>${projList.empName}</td>
								 
									<td style="width: 200px">
										<c:forEach items="${projList.devloperListFromTask}" var="devloperListFromTask" varStatus="count">
										${devloperListFromTask.developerName},
										
								 </c:forEach>
										 </td>
									 
										 <td>${projList.devPer}</td>
										 <td>${projList.compPer}</td>
									</tr>
								</c:forEach>
