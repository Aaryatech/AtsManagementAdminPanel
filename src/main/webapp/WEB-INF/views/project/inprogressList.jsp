			...
			<div class="page-title">
				<div>
					<h1>
						...
						<i class="fa fa-file-o"></i>Inprogress
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Inprogress Task List
							</h3>
							...
							<div class="table-responsive" style="border: 0">
								<table class="table table-advance" id="table1">
									...
									<tbody>
										...
										<c:forEach items="${inprogress}" var="inprogress"
											varStatus="count">
											<tr class="table-flag-blue">
												...
												<td><a
													href="${pageContext.request.contextPath}/inprogressTaskDetails/${inprogress.taskId}">
