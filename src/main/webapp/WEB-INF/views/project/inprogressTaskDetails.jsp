			...
			<div class="page-title">
				<div>
					<h1>
						...
						<i class="fa fa-file-o"></i>Task Details
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Task Details
							</h3>
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/deatilsList">Task
									Details</a> <a data-action="collapse" href="#"><i
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input type="text" name="empMo"
											value="${taskList.formName}" class="form-control"
											placeholder=" Form Name"readonly/ 
													  >
									</div>
								</div>
								<br>
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input type="text" name="empEdu"
											value="${taskList.taskName}" class="form-control"
											placeholder="Task Name" readonly />
									</div>
									<div class="col-md-1"></div>
