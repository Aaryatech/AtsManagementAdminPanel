								...
								<form action="${pageContext.request.contextPath}/insertLeave"
									...
									<div class="form-group">
										...
										<label class="col-sm-3 col-lg-2 control-label">Request
											To</label>
										<div class="col-sm-4 col-lg-3 controls">
											<select name="sendTo" id="sendTo" class="form-control chosen"
												placeholder="Send To" required>
									...
									<div class="form-group">
										...
										<label class="col-sm-3 col-lg-2 control-label">To Date
										</label>
										<div class="col-sm-4 col-lg-3 controls">
									...
									<div class="form-group">
										<label class="col-sm-3 col-lg-2 control-label">Type of
											Leave </label>
										<div class="col-sm-4 col-lg-3 controls">
