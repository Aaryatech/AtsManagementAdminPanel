...
//            text.setPaddingLeft(10);
            text.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            text.setVerticalAlignment(PdfPCell.ALIGN_LEFT);
            text.setBorder(Rectangle.NO_BORDER);
            text.addElement(new Phrase(StrHeader, new Font(FontFamily.TIMES_ROMAN, 12.0f, Font.BOLD, BaseColor.BLACK)));
           // text.addElement(new Phrase("\n        "+strTitle +"   Date:  "+strDate, new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD, BaseColor.BLACK)));
            ...
            header.writeSelectedRows(0, -1, 20, 803, writer.getDirectContent());//value 20 changed it was 100 before  to set align left proj name
        } catch(DocumentException de) {
            throw new ExceptionConverter(de);
        } 
    }
